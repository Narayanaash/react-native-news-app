...
const newsURI =
  "https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=ad56a8b4ed7343d5962addccc3e77b13";
  ...
  render() {
    return (
      <Container style={styles.container}>
        <HeaderScreen navigation={this.props.navigation} title="Business" />
