...
const newsURI =
  "http://newsapi.org/v2/everything?q=politics&sortBy=publishedAt&apiKey=ad56a8b4ed7343d5962addccc3e77b13";
  ...
  render() {
    return (
      <Container style={styles.container}>
        <HeaderScreen navigation={this.props.navigation} title="Politics" />
